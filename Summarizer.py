...
def get_summary(information: str) -> str | None:
    """
    Takes information about a person and returns a summary 
    and two interesting facts using a LangChain LCEL chain.
    """
    ...
    try:
        ...
        print(f"❌ An error occurred during summary generation: {str(e)}")
        return None
...
"""
    ...
    print("🤖 Generating summary using LCEL chain...")
